...
//           // 🔧 NORMALIZE shape:
//           // you currently have: [ { 0: { ...orderFields } } ]
//           // we want: [ { ...orderFields } ]
...
//   // just to see what goes to the grid
//   useEffect(() => {
...
//         cellRenderer: (params: any) => {
//           return (
//             <div className="py-2 text-center">{params.value}</div>
//           );
//         },
//         width: 100,
//         minWidth: 80,
...
//                 Number(pnl) >= 0 ? "text-emerald-600" : "text-rose-600"
//               }`}
//             >
//               {pnl !== "—" ? `₹${pnl}` : pnl}
//             </p>
