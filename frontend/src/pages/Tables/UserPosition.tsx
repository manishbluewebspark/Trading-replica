...
//   const qty = Number(order.fillsize || order.quantity || 0);
//   const price = Number(order.fillprice || order.averageprice || 0);
...
//        console.log('==============tick user position===========',tick);
//       setLtpByToken((prev) => {
...
//       cellStyle: { borderRight: '1px solid #e2e8f0' }
//     },  
//     // 🔥 CMP COLUMN (same styling pattern)
// {
//   headerName: "CMP",
//   field: "symboltoken",
//   cellRenderer: (params: any) => {
//     const token = params.data?.symboltoken;
//     const cmp = token ? ltpByToken[token] : undefined;

//     return (
//       <div className="py-2 text-right font-semibold">
//         {cmp !== undefined ? `₹${cmp.toFixed(2)}` : "—"}
//       </div>
//     );
//   },
//   width: 120,
...
// // 🔥 PnL COLUMN (same look & feel)
// {
//   headerName: "PnL",
//   field: "pnl",
//   cellRenderer: (params: any) => {
//     const order = params.data as Order;
//     const cmp = ltpByToken[order.symboltoken];
//     const pnl = calculatePnL(order, cmp);
...
//   console.log((cmp - price) * qty,'check');
...
//   const MobileOrderCard = ({ order }: { order: Order }) => {
//     const live = order?.symboltoken ? ltpByToken[order?.symboltoken] : undefined;
//     const pnl = calculatePnL(order, live);
