...
// ================ without SL and Target Updated but Wroking Code===================
...
// /** ✅ Inline number input (onBlur commit) */
...
// const DetailRowRenderer = (props: any) => {
//   const row = props.data as DetailRow;
//   const { onSellFromSub, ltpByToken, updateOcoForOrder } = props.context || {};
...
//   /** ✅ API: update Target/SL (onBlur) */
//   const updateOcoForOrder = useCallback(
...
//       console.log(payload,'==============payload=========',"stoploss and target object");
      

//       try {
//         const res = await axios.post(
//           `${apiUrl}/admin/multiple/targetstoploss/order`,
//           payload,
//           { headers: { Authorization: `Bearer ${localStorage.getItem("token") || ""}` } }
//         );
...
//                   userId: row.userId,   // optional
//                   broker: row.broker,   // optional
//                 })
//               }
//             />
//           );
...
//                   strategyUniqueId: row.strategyUniqueId || "",
//                   stoplossPrice: val,
//                   targetPrice: row.squareoff ?? null,
//                   userId: row.userId,
//                   broker: row.broker,
//                 })
//               }
...
//       { headerName: "Created Time", field: "createdAt", width: 290 },
//     ],
//     [handleSellMain, ltpByToken, updateOcoForOrder]
//   );
...
//               onSellFromSub: handleSellFromSub,
//               ltpByToken,
//               updateOcoForOrder, // ✅ IMPORTANT for subtable
//             }}
//             getRowId={getRowId}
//             isFullWidthRow={isFullWidthRow}
//             fullWidthCellRenderer={fullWidthCellRenderer}
