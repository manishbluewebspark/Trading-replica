...
//   const { api, image,brokerName } = useBrokerApi();
...
//       window.open(res.authUrl, "_blank");   // ⬅️ open Upstox OAuth screen
//       return;
//       }
...
//               <p className="text-2xl font-bold bg-linear-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent mr-2 max-w-[180px] truncate">
//            {rupee(fundData)}
//           </p>

//             </div>
//             <div className="p-4 bg-linear-to-br from-emerald-50 to-green-100 rounded-2xl">
//               <RiWallet3Line className="text-emerald-500 text-sm" />
//             </div>
//           </div>
//           <div className="flex items-center gap-2 text-sm text-gray-500 mt-4">
...
//                 </p>
//                 <p className="text-xs text-gray-400 mt-1"> {timeAgo(item.ordertime)}</p>
